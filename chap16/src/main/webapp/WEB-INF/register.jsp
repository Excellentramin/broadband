...
<div class="logo">
	...
	<div id="bigBox">
			...
			<div class="inputBox">
				...
				<div class="adminbox"><i class="fa fa-user-circle" style="color: whitesmoke;">管理员注册</i><input type="checkbox"name="ad" value="ad"/></div>
				<a href="login"><input type="button" class="inputButton" value="登录" /></a>
